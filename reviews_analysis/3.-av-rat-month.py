...
chart_def = """
 {
    ...
    title: {
        text: 'Avarage rating by month'
    },
    subtitle: {
        text: 'According to the Course Dataset'
    },
    xAxis: {
        reversed: false,
        title: {
...
def app():
    ...
    hc.options.xAxis.categories = list(month_avarage.index)
    hc.options.series[0].data = list(month_avarage['Rating'])
    return wp
